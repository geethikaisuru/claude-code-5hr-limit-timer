interface ResetInfo {
    date: string;
    time: string;
    clickedTimers?: number[];
}

class ClaudeTimerTracker {
    private resetDateInput: HTMLInputElement;
    private resetTimeInput: HTMLInputElement;
    private calculateBtn: HTMLButtonElement;
    private clearBtn: HTMLButtonElement;
    private resultsSection: HTMLElement;
    private resetTimesDiv: HTMLElement;
    private clickCounter: HTMLElement;
    private clickCount: number = 0;

    constructor() {
        this.resetDateInput = document.getElementById('resetDate') as HTMLInputElement;
        this.resetTimeInput = document.getElementById('resetTime') as HTMLInputElement;
        ...
        this.resetTimesDiv = document.getElementById('resetTimes') as HTMLElement;
        this.clickCounter = document.getElementById('click-counter') as HTMLElement;
    ...
    private loadSavedData(): void {
        ...
        if (savedData) {
            try {
                const resetInfo: ResetInfo = JSON.parse(savedData);
    ...
    private saveData(clickedTimers?: number[]): void {
    ...
    private initializeClickCounter(): void {
    ...
    private updateClickCounter(): void {
    ...
    private calculateResetTimes(startDateStr: string, startTimeStr: string): Date[] {
    ...
    private displayResetTimes(resetTimes: Date[], clickedTimers: number[] = []): void {
